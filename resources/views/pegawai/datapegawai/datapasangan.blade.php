...
<div class="modal fade" id="addPasangan">
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content modal-content-demo">
         ...
         <form class="form-horizontal" action="/insertpasangan" method="POST" enctype="multipart/form-data">
         @csrf
...
<div class="modal fade" id="update{{ $up->id }}">
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content modal-content-demo">
         ...
         <form class="form-horizontal" action="/updatepasangan" method="POST" enctype="multipart/form-data">
         @csrf
         <div class="modal-body">
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">      
         <div class="modal-body text-center">
               ...
               <button class="btn btn-default" data-bs-dismiss="modal">Batal</button>&emsp; <a type="submit" class="btn btn-danger pd-x-25" href="/deletepasangan/{{ $up->id }}">Hapus</a>
         </div>         
      </div>
   </div>
</div>
