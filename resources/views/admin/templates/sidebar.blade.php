	...
	<div class="app-sidebar">
		...
		<div class="main-sidemenu">			
			<ul class="side-menu">
				...
				<li class="slide">
					<a class="side-menu__item has-link" data-bs-toggle="slide" href="/viewpengajuan"><i
							class="side-menu__icon fe fe-file-text"></i><span
							class="side-menu__label">Permohonan Cuti</span></a>
				</li>
				<li class="slide">
					<a class="side-menu__item has-link" data-bs-toggle="slide" href="/riwayatcuti"><i
							class="side-menu__icon fe fe-clock"></i><span
							class="side-menu__label">Riwayat Cuti</span></a>
				</li>
				<li class="slide">
					<a class="side-menu__item has-link" data-bs-toggle="slide" href="/importcuti"><i
