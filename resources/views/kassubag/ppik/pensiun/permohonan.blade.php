                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-footer mt-4 offset-5">
                                <a href="/viewpengajuanpensiun" class="btn btn-default">Kembali</a>
...
<div class="modal fade" id="modaldemo8">
    <div class="modal-dialog modal-dialog-centered text-center" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <form class="form-horizontal" action="/konfirmasiberkas" method="POST" enctype="multipart/form-data">
            @csrf
...
<div class="modal fade" id="addPasfoto">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <form class="form-horizontal" action="/insertdokumen" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-body">            
