                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $pensiun->pendidikan_diangkat }}" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Alamat Sesudah Pensiun</label>
                                        <input type="text" class="form-control" value="{{ $pensiun->alamat_baru . ', ' . $pensiun->kecamatan_baru . ', ' .  $pensiun->kabupaten_baru . ', ' . $pensiun->provinsi_baru . ', ' . $pensiun->kodepos_baru}}" readonly>
                                    </div>
                                </div>
                                        ...
                                        <table class="table border text-nowrap text-md-nowrap table-striped mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td>Pas Foto</td>
                                                    <td>@if($berkas->pasfoto)<a class="btn btn-success btn-sm" title="Lihat File" target="_blank" href="/{{ $berkas->pasfoto }}"><i class="fa fa-file"></i> Lihat File</a>@endif</td>
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addPasfoto"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                    <td>DPCP</td>
                                                    <td>@if($berkas->dpcp)<a class="btn btn-success btn-sm" title="Lihat File" target="_blank" href="/{{ $berkas->dpcp }}"><i class="fa fa-file"></i> Lihat File</a>@endif</td>
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addDpcp"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>3</td>
                                                    <td>Pengantar OPD</td>
                                                    ...
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addPengantar"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>4</td>
                                                    <td>SK CPNS</td>
                                                    ...
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addSkcpns"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>5</td>
                                                    <td>SK PNS</td>
                                                    ...
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addSkpns"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>6</td>
                                                    <td>SK Pangkat Terakhir</td>
                                                    <td>@if($berkas->sk_pangkat)<a class="btn btn-success btn-sm" title="Lihat File" target="_blank" href="/{{ $berkas->sk_pangkat }}"><i class="fa fa-file"></i> Lihat File</a>@endif</td>
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addSkpangkat"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>7</td>
                                                    <td>SK Berkala</td>
                                                    <td>@if($berkas->sk_berkala)<a class="btn btn-success btn-sm" title="Lihat File" target="_blank" href="/{{ $berkas->sk_berkala }}"><i class="fa fa-file"></i> Lihat File</a>@endif</td>
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addSkberkala"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>8</td>
                                                    <td>Karpeg</td>
                                                    <td>@if($berkas->karpeg)<a class="btn btn-success btn-sm" title="Lihat File" target="_blank" href="/{{ $berkas->karpeg }}"><i class="fa fa-file"></i> Lihat File</a>@endif</td>
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addKarpeg"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>9</td>
                                                    <td>SKP</td>
                                                    <td>@if($berkas->skp)<a class="btn btn-success btn-sm" title="Lihat File" target="_blank" href="/{{ $berkas->skp }}"><i class="fa fa-file"></i> Lihat File</a>@endif</td>
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addSkp"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>10</td>
                                                    <td>Surat Nikah</td>
                                                    ...
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addSuratnikah"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>11</td>
                                                    <td>Kartu Keluarga</td>
                                                    <td>@if($berkas->kartukeluarga)<a class="btn btn-success btn-sm" title="Lihat File" target="_blank" href="/{{ $berkas->kartukeluarga }}"><i class="fa fa-file"></i> Lihat File</a>@endif</td>
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addKartukeluarga"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>12</td>
                                                    <td>Akte Kelahiran</td>
                                                    <td>@if($berkas->aktekelahiran)<a class="btn btn-success btn-sm" title="Lihat File" target="_blank" href="/{{ $berkas->aktekelahiran }}"><i class="fa fa-file"></i> Lihat File</a>@endif</td>
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addAkte"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>13</td>
                                                    <td>SK NIP Baru</td>
                                                    <td>@if($berkas->sk_nipbaru)<a class="btn btn-success btn-sm" title="Lihat File" target="_blank" href="/{{ $berkas->sk_nipbaru }}"><i class="fa fa-file"></i> Lihat File</a>@endif</td>
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addSknipbaru"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>14</td>
                                                    <td>Akta Mati Cerai</td>
                                                    <td>@if($berkas->akta_maticerai)<a class="btn btn-success btn-sm" title="Lihat File" target="_blank" href="/{{ $berkas->akta_maticerai }}"><i class="fa fa-file"></i> Lihat File</a>@endif</td>
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addAktamati"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>15</td>
                                                    <td>Surat Pernyataan Hukuman Disiplin</td>
                                                    <td>@if($berkas->sp_hukdis)<a class="btn btn-success btn-sm" title="Lihat File" target="_blank" href="/{{ $berkas->sp_hukdis }}"><i class="fa fa-file"></i> Lihat File</a>@endif</td>
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addSuratdisiplin"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>16</td>
                                                    <td>Surat Pernyataan Bebas Pidana</td>
                                                    <td>@if($berkas->sp_pidana)<a class="btn btn-success btn-sm" title="Lihat File" target="_blank" href="/{{ $berkas->sp_pidana }}"><i class="fa fa-file"></i> Lihat File</a>@endif</td>
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addSuratpidana"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                                <tr>
                                                    <td>17</td>
                                                    <td>Surat Keterangan Penambahan Masa Kerja</td>
                                                    <td>@if($berkas->sk_pmk)<a class="btn btn-success btn-sm" title="Lihat File" target="_blank" href="/{{ $berkas->sk_pmk }}"><i class="fa fa-file"></i> Lihat File</a>@endif</td>
                                                    <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addSuratpmk"><i class="fa fa-upload"></i></button></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
